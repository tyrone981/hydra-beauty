...
export default function About() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-[1] bg-gradient-to-br from-[#b89a6e]/10 via-[#0d1a1c] to-[#b89a6e]/10 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center relative z-10">
        ...
        >
          ...
          <p className="text-[#c8beb4] text-sm lg:text-base leading-relaxed max-w-md">
            Hydra Beauty est un institut de beauté situé à Douala, dédié à
            l'élégance, au soin et au bien-être.
          </p>

          <p className="text-[#c8beb4] text-sm lg:text-base leading-relaxed max-w-md">
            Présents à <span className="text-[#b89a6e]">Akwa</span> et{" "}
            <span className="text-[#b89a6e]">New-Bell</span>, nous vous
            accueillons chaque jour.
          </p>
          ...
          <a
            href="#services"
            className="self-start px-8 py-3 rounded-full border border-[#b89a6e] text-[#f0e8dd] text-xs tracking-[0.25em] uppercase hover:bg-[#b89a6e] hover:text-[#0d1a1c] transition"
          >
            Découvrir nos soins
          </a>
        </motion.div>
        ...
        >
          <div className="relative w-[320px] h-[320px] md:w-[440px] md:h-[440px]">
            ...
            <div className="absolute inset-0 rounded-full border-2 border-[#b89a6e]/80" />

            
            <div className="absolute inset-4 rounded-full border border-[#b89a6e]/40" />

            
            <div className="absolute inset-8 rounded-full overflow-hidden border border-[#b89a6e]/30 shadow-[0_0_80px_rgba(184,154,110,0.12)]">
              <Image
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute -bottom-6 -right-6 bg-[#0d1a1c]/90 border border-[#b89a6e]/30 backdrop-blur-md px-6 py-4 rounded-xl"
            >
