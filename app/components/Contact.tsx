...
export default function Contact() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-[#b89a6e]/8 via-[#0d1a1c] to-[#b89a6e]/5 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            <InfoCard
              title="Localisation"
              lines={["Akwa & New-Bell, Douala"]}
            />

            <InfoCard
              title="Téléphone"
              lines={["6 97 83 98 18 / 6 75 01 46 18"]}
            />

            <InfoCard
              title="Horaires"
              lines={["7 jours / 7", "08h00 - 20h00"]}
            />

            <InfoCard
              title="Offre"
              lines={["3 Prestations - 10.000 FCFA"]}
            />
          </motion.div>
          ...
          >
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[#b89a6e] text-xs uppercase tracking-[0.18em]">
                  Service
                </label>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="bg-[#111f22]/80 border border-[#b89a6e]/20 text-[#f0e8dd] px-4 py-3"
                >
              ...
              <a
                href={whatsappLink}
                target="_blank"
                className="block w-full text-center py-4 bg-[#b89a6e] text-[#0d1a1c] uppercase tracking-[0.2em]"
              >
...
function InfoCard({ title, lines }: { title: string; lines: string[] }) {
  return (
    <div className="p-4 border border-[#b89a6e]/15 bg-[#111f22]/50">
      <p className="text-[#b89a6e] text-xs uppercase tracking-[0.15em] mb-2">
        {title}
      </p>
      {lines.map((l) => (
        <p key={l} className="text-[#c8beb4] text-sm">
          {l}
        </p>
      ))}
    </div>
